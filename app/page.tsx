...
export default function HomePage() {
  const featuredPrograms = [
    ...
    },
    {
      ...
      description: "Essential support for UK university applications with professional guidance and assistance.",
      benefits: ["2 applications", "Application support", "20+ countries", "Flight discount"],
      deadline: "Rolling admissions",
    },
    {
      id: 3,
      ...
      description: "Comprehensive UK university application support with visa assistance and documentation help.",
    ...
    },
    {
      ...
      description: "Premium UK university application package with guaranteed admissions and comprehensive support.",
