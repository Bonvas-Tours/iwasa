...
const programData = {
    ...
    testimonials: [
      {
        ...
        image: "/testimonial/internship/1.jpg",
        quote:
      ...
      },
      {
        ...
        image: "/testimonial/internship/2.jpg",
        quote:
  ...
  2: {
    ...
    description:
      "Essential support for international university applications with professional guidance and assistance. Perfect for students seeking basic application support for their global education journey.",
    longDescription:
      "The Bronze Package provides fundamental support for students applying to universities worldwide. This package includes professional application assistance for up to 2 universities, covering over 50 countries for international students. Our experienced team will guide you through the application process, ensuring your applications meet international university standards and requirements.",
    benefits: [
    ...
    deadline: "Rolling admissions",
    startDate: "Immediately upon enrollment",
    cost: "$1,800",
    paymentOptions: [
      {
        option: "Down Payment",
  ...
  3: {
    ...
    description:
      "Comprehensive international university application support with visa assistance and documentation help. Ideal for students who need additional support beyond basic applications.",
    longDescription:
      "The Silver Package offers enhanced support for international university applications, including visa assistance and comprehensive documentation support. This package covers 3 university applications with professional guidance, visa application assistance, and a robust refund policy. Perfect for students who want additional security and support throughout their application journey.",
    benefits: [
  ...
  4: {
    ...
    description:
      "Premium international university application package with guaranteed admissions and comprehensive support. The ultimate package for students who want maximum support and guaranteed results.",
    longDescription:
      "The Gold Package is our premium offering, providing comprehensive support for international university applications with guaranteed admissions. This package includes 5 university applications, financial aid and scholarship support, travel insurance, accommodation search assistance, and much more. With 12 months validity and extensive benefits, this package ensures your success in securing admission to a university worldwide.",
    benefits: [
